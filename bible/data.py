...
name_data = {
    ...
    ref.BibleBook._1Sam:    ("1Sam",    "1 Samuel",         1,   ["1 Sm"]),
    ref.BibleBook._2Sam:    ("2Sam",    "2 Samuel",         1,   ["2 Sm"]),
    ref.BibleBook._1Kgs:    ("1Kgs",    "1 Kings",          1,   ["1 Kg", "1 Kgs"]),
    ref.BibleBook._2Kgs:    ("2Kgs",    "2 Kings",          1,   ["2 Kg", "2 Kgs"]),
    ref.BibleBook._1Chr:    ("1Chr",    "1 Chronicles",     2,   []),
    ref.BibleBook._2Chr:    ("2Chr",    "2 Chronicles",     2,   []),
    ...
    ref.BibleBook._1Cor:    ("1Cor",    "1 Corinthians",    2,   []),
    ...
    ref.BibleBook._2Pet:    ("2Pet",    "2 Peter",          1,   ["2 Pt"]),
    ref.BibleBook._1Jn:     ("1Jn",     "1 John",           1,   ["1 Jn", "1 Jhn"]),
    ref.BibleBook._2Jn:     ("2Jn",     "2 John",           1,   ["2 Jn", "2 Jhn"]),
    ref.BibleBook._3Jn:     ("3Jn",     "3 John",           1,   ["3 Jn", "3 Jhn"]),
...
order = [
    ...
    ref.BibleBook.Phil,
    ref.BibleBook.Col,
    ref.BibleBook._1Thess,
    ref.BibleBook._2Thess,
    ref.BibleBook._1Tim,
    ref.BibleBook._2Tim,
    ref.BibleBook.Titus,
    ref.BibleBook.Phlm,
...
max_verses = {
    ...
    ref.BibleBook._1Sam:    [28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42, 15, 23, 29, 22, 44, 25, 12, 25, 11, 31, 13],
    ref.BibleBook._2Sam:    [27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 33, 43, 26, 22, 51, 39, 25],
    ref.BibleBook._1Kgs:    [53, 46, 28, 34, 18, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43, 29, 53],
    ref.BibleBook._2Kgs:    [18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 21, 21, 25, 29, 38, 20, 41, 37, 37, 21, 26, 20, 37, 20, 30],
    ref.BibleBook._1Chr:    [54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 47, 40, 14, 17, 29, 43, 27, 17, 19, 8, 30, 19, 32, 31, 31, 32, 34, 21, 30],
    ref.BibleBook._2Chr:    [17, 18, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 22, 15, 19, 14, 19, 34, 11, 37, 20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23],
    ...
    ref.BibleBook._1Cor:    [31, 16, 23, 21, 13, 20, 40, 13, 27, 33, 34, 31, 13, 40, 58, 24],
    ref.BibleBook._2Cor:    [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 14],
    ...
    ref.BibleBook._1Thess:  [10, 20, 13, 18, 28],
    ref.BibleBook._2Thess:  [12, 17, 18],
    ref.BibleBook._1Tim:    [20, 15, 16, 16, 25, 21],
    ref.BibleBook._2Tim:    [18, 26, 17, 22],
    ref.BibleBook.Titus:    [16, 15, 15],
    ref.BibleBook.Phlm:     [25],
    ref.BibleBook.Heb:      [14, 18, 19, 16, 14, 20, 28, 13, 28, 39, 40, 29, 25],
    ref.BibleBook.James:    [27, 26, 18, 17, 20],
    ref.BibleBook._1Pet:    [25, 25, 22, 19, 14],
    ref.BibleBook._2Pet:    [21, 22, 18],
    ref.BibleBook._1Jn:     [10, 29, 24, 21, 21],
    ref.BibleBook._2Jn:     [13],
    ref.BibleBook._3Jn:     [14],
